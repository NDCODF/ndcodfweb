...
./configure --with-lo-path=/opt/ndcodfsys --enable-ssl --disable-werror --with-max-documents=10240 --with-max-connections=10240 --enable-debug --with-lokit-path=bundled/include
